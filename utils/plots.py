...
def feature_visualization(features, title='None', feature_num=64):
    """
    ...
    """
    save_dir = "feature_visualization/"
    ...
    plt.savefig(save_dir + '{}_{}_{}.png'
                .format(title, feature_num, time.time()), dpi=300)